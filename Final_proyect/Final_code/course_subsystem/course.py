...
DATABASE_CONNECTION = f"postgresql://{DB_USER}:{DB_PASSWORD}@{DB_URL}:{DB_PORT}/{DB_NAME}"
...
course=CourseDAO()
course.add_course(CourseDE(name="Python", description="Python course", price=100.0, available=True))
